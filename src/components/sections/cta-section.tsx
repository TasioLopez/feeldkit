...
export function CTASection() {
  return (
    <section className="overflow-hidden rounded-2xl border border-border/70 bg-gradient-to-r from-brand-soft/50 via-card to-subtle px-6 py-10 shadow-md sm:px-8">
